...
```bash
# With SSH
git clone -b t3 git@github.com:jobucaldas/3DCLT-TC.git
git clone -b t3 git@github.com:jobucaldas/auth-service.git
git clone -b t3 git@github.com:jobucaldas/analytics-service.git
git clone -b t3 git@github.com:jobucaldas/evaluation-service.git
git clone -b t3 git@github.com:jobucaldas/flag-service.git
git clone -b t3 git@github.com:jobucaldas/targeting-service.git
